...
#############################
## Normalize (RefSeq 20621) # 20220325
#############################
...
# ------------------------
plot(density(MG9_18$TTseq_MG9_18, to=100),col="indianred1",lwd=2,main="reads_normalized")
lines(density(MG9_16$TTseq_MG9_16, to=100),lwd=2,col="red")
lines(density(MG9_12$TTseq_MG9_12, to=100),lwd=2,col="blue")
lines(density(MG9_14$TTseq_MG9_14, to=100),lwd=2,col="deepskyblue")
legend("topright", c("WT1 5 (MG9_12)","WT2 5 (MG9_14)", "TKO1 5 (MG9_16)","TKO2 5 (MG9_18)","threshold at 10"), col=c("blue", "deepskyblue", "red","indianred1","grey"), 
       lwd=c(2,2,2,2,1.5), lty=c(1,1,1,1,2), inset = .02)
abline(v=10, col="grey",lwd=1.5, lty=2)

# ------------
# Histograms | non-informative
# ------------
MG9_12_by_size <- MG9_12[order(MG9_12$TTseq_MG9_12, decreasing = F),] # sort by size
head(MG9_12_by_size)
hist(MG9_12_by_size$TTseq_MG9_12,
     breaks=100,
     col=0,
     main = paste("MG9_11"),
     xlab = paste("rate"))
...
# --------------------------------------------------------------
MG9_12_fil <- MG9_12[MG9_12$TTseq_MG9_12>0.7 & (MG9_12$End - MG9_12$Start)>,]
nrow(MG9_12_fil)
summary(MG9_12)
