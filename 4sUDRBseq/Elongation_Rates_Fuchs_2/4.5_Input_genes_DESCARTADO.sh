...
paste /media/cc/B/Josemi/TTseq_Feb2022/TTseq_output/Elongation_rate_2/3.2_Normalization_3Kb/Intersect_RefSeq3Kb_Normalized_MG9_12.txt /media/cc/B/Josemi/TTseq_Feb2022/TTseq_output/Elongation_rate_2/3.2_Normalization_3Kb/Intersect_RefSeq3Kb_Normalized_MG9_14.txt /media/cc/B/Josemi/TTseq_Feb2022/TTseq_output/Elongation_rate_2/3.2_Normalization_3Kb/Intersect_RefSeq3Kb_Normalized_MG9_16.txt /media/cc/B/Josemi/TTseq_Feb2022/TTseq_output/Elongation_rate_2/3.2_Normalization_3Kb/Intersect_RefSeq3Kb_Normalized_MG9_18.txt | awk -v OFS="\t" '($6>0.7 && $12>0.7 && $18>0.7 && $24>0.7){print $1,$2,$3,$4,1,$5}' > $OUT/MYGENES.bed
...
printf "RN\tID\tChromosome\tOrientation\tStart\tEnd\tCDS_start\tCDS_end\tExon_number\tExon_starts\tExon_ends\tZ\tName\tcmpl1\tcmpl2\tSP\n" > $OUT/Input_genes_3Kb.txt
cat REMOVE.ME2 | grep -v chrZ | sort -k3,3 -k5,5n -k6,6n | sed 's/chrX/20/g' | sed 's/chrY/21/g' | sed 's/chr//g' | sed "s/\t+\t/\t1\t/g" | sed "s/\t-\t/\t2\t/g" >> $OUT/Input_genes_3Kb.txt
