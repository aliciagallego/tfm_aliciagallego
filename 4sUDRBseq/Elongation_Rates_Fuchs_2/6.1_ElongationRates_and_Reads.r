...
TTseq_Rates_path <- "/media/cc/B/Josemi/TTseq_Feb2022/TTseq_output/Elongation_rate_2/1.1_Rate_calculation/Elongation_rate_5min_20220326.txt"
...
png(file = paste0(output, "5_Plots/Plot_rates_and_reads_TKO.png"))
...
png(file = paste0(output, "5_Plots/Plot_reads_and_rates_WT.png"))
...
png(file = paste0(output, "5_Plots/Plot_reads_and_rates_TKO.png"))
